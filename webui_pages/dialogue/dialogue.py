...
def dialogue_page(api: ApiRequest):
    ...
    with st.sidebar:
        ...
        def prompt_change():
            text = f"已切换为 {st.session_state.prompt_template_select} 角色身份。"
            st.toast(text)
        ...
        temperature = st.slider("温度：", 0.0, 1.0, TEMPERATURE, 0.05)
