...
MODEL_PATH = {
    "embed_model": {
        ...
        "piccolo-base-zh": "/content/drive/MyDrive/LLM/piccolo-base-zh",
    ...
    "llm_model": {
        ...
        # "Qwen-7B-Chat-int4":"/content/drive/MyDrive/LLM/Qwen-7B-Chat-Int4",
        # "Qwen-14B-Chat":"Qwen/Qwen-14B-Chat",
    },
}
# 选用的 Embedding 名称
EMBEDDING_MODEL = "piccolo-base-zh" # 可以尝试最新的嵌入式sota模型：bge-large-zh-v1.5
...
ONLINE_LLM_MODEL = {
    ...
    "qwen-api": {
        ...
        "api_key": "qwen-api-xxxxxxx",  # 请在阿里云控制台模型服务灵积API-KEY管理页面创建
        "provider": "QwenWorker",
    },
